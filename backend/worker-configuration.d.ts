/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fafbe2b31bbc4521f873c37f5b841ba4)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	NOTIFICATIONS: Queue;
	APNS_KEY_ID: "N3PN5DQTL5";
	APNS_TEAM_ID: "Z9369NJFAQ";
	APNS_TOPIC: "app.nutridrop";
	APNS_ENVIRONMENT: "sandbox";
	MCP_RESOURCE: "https://nutridrop-mcp-staging.diamondaleksandr.workers.dev/mcp" | "http://localhost:8787/mcp";
	WORKOS_ISSUER: "https://resilient-quest-95-staging.authkit.app";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		APNS_TOPIC: "app.nutridrop";
		APNS_ENVIRONMENT: "sandbox";
		MCP_RESOURCE: "https://nutridrop-mcp-staging.diamondaleksandr.workers.dev/mcp";
		WORKOS_ISSUER: "https://resilient-quest-95-staging.authkit.app";
		APNS_PRIVATE_KEY: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APNS_KEY_ID" | "APNS_TEAM_ID" | "APNS_TOPIC" | "APNS_ENVIRONMENT" | "MCP_RESOURCE" | "WORKOS_ISSUER" | "APNS_PRIVATE_KEY">> {}
}
